...
def run_experiment(
    ...
    for i, (key, score, analysis) in enumerate(ranked[:10]):
        ...
        logger.info(
            f"     Score: {score:.1f}, Linear: {analysis.get('linear_feature_count', 0)}, "
...
Examples:
    ...
    parser.add_argument("--decomp", nargs="+", default=None, help="Decomposition methods to use")
    parser.add_argument("--upsamp", nargs="+", default=None, help="Upsampling methods to use")
