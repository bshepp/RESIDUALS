...
def main():
    ...
    parser.add_argument(
        "--source", type=str, default=str(RESULTS_DIR), help="Source directory with .npy files"
    )
    parser.add_argument(
        "--checkpoint", type=str, default=str(CHECKPOINT_FILE), help="Checkpoint file path"
    )
    parser.add_argument(
        "--interval",
        type=int,
    ...
    print(f"{'=' * 60}")
    print("RESIDUALS Parallel Fingerprint Generator")
    print(f"{'=' * 60}")
